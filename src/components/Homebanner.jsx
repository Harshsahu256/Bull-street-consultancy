...
const Homebanner = () => {
  return (
    ...
    <div className="row " >
     ...
     <span className='' style={{fontWeight:700}}> Option Money Research </span> </h4>
        ...
        Discover Option Money Research  – Your Trusted Source for Stock Market Expertise! Our team is here to guide you with personalized tips and strategies, revealing the secrets of the Indian market.   </p>
