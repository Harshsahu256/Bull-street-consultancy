    ...
    <div className=' container '>
        <div className='row '>
            ...
            <div className="col-md-6 col-12">
                <h5 className='common-heading2-product '>Advantage of trading in Equity Derivative</h5>
                <div className='li-container'>
                    <ul >
                        <li className='text-start product-litag'> Enables short selling and other strategies not possible in cash markets. </li>
                        <li className='text-start product-litag'>Offers various strategies for traders and investors.</li>
                        <li className='text-start product-litag'>Provides an effective tool for managing risks.</li>
                        <li className='text-start product-litag'>Allows large transactions with smaller capital investment.</li>
                        <li className='text-start product-litag'>  High liquidity benefits intraday traders.</li>
                        <li className='text-start product-litag'> Reduced transaction costs compared to cash markets.</li>
                    </ul>
                </div>
                ...
                <div className='li-container'>
                    <ul >
                        ...
                        <li className='text-start product-litag'> Convenient access to your ledger balances and account information.</li>
                        <li className='text-start product-litag'>Monthly Option Trading strategies for expiry designed for profitability.</li>
                        <li className='text-start product-litag'> Latest news feeds impacting equity markets are always available.</li>
                        <li className='text-start product-litag'>We maintain full transparency in all our operations.</li>
                        <li className='text-start product-litag'> Round-the-clock back-office assistance.</li>
                        <li className='text-start product-litag'> A dedicated help desk for all equity market-related queries.</li>
                    </ul>
                </div>
            </div>
        </div>  
...
export default EquityDeriAdvantage