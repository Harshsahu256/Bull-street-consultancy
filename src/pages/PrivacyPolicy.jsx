...
const PrivacyPolicy = () => {
    return (<>
        ...
        <h2 className= ' headingcommon mt-4'>Privacy Policy</h2>
            <div
      ...
      <p className=' bannerpara font400'>We collect information to provide you with high-quality services. This may include:</p>
      <ul>
      <li className=' bannerpara font400' >Providing services you request</li>
      <li className=' bannerpara font400' >Confirming your identity</li>
      <li className=' bannerpara font400' >Protecting against fraud</li>
      <li className=' bannerpara font400' >Managing our relationship with you</li>
      </ul>
        <p className=' bannerpara font400'>Your personal information will only be used to provide the services you have subscribed to and will not be sold, rented, exchanged, or shared with any third party without your consent. We do not engage in spam.</p>
      ...
      <p className=' bannerpara font400'>All payment information, including transaction details, is securely processed. We take appropriate measures to protect your payment information using a secure payment gateway.</p>
      ...
      <p className=' bannerpara font400'>By using our services, you consent to the terms of this Privacy Policy and our Terms of Use.</p>
        </div>
        </>
      );
}
